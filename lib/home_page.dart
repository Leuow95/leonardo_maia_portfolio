...
import 'package:leonardo_maia_portfolio/widgets/project_card.dart';
      ...
      body: SizedBox(
        ...
        child: const Padding(
          ...
          child: Column(
            ...
            children: [
              Text("About", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 24)),
              Text(
              ...
              Text("Projects", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 24)),
              ProjectCard(),
            ],
          ),
        ),
